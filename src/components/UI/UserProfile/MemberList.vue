...
#memberList .statusOffline{
  font-size:12px;
  color:rgb(221,221,211);
}
#memberList .statusBusy{
  font-size:12px;
  color:rgb(179,60,18);
}
#memberList .statusOnline{
  font-size:12px;
  color:rgb(34,152,99);
}
#memberList .contact{
